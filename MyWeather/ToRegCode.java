public class ToRegCode {
        public String addressToRegCode(String address) {
            if (address.contains("백령도")) {
                return "11A00101";
                ...
                return "11D20401";
            }else if (address.contains("고성")&& address.contains("강원도")) {
                return "11D20402";
                ...
                return "11F20404";
            }else if (address.contains("순천")&& address.contains("전라남도")) {
                return "11F20405";
